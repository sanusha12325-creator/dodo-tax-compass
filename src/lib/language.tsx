...
const translations: Record<string, Record<Language, string>> = {
  ...
  "checklist.cv.calculated": { ru: "Рассчитать приблизительную стоимость расходов и доходов", en: "Estimate costs and income" },
  "checklist.cv.fillPyrus": { ru: "Заполнить форму на конвертацию опционов", en: "Fill out the option conversion form" },
  "checklist.cv.signedDocs": { ru: "Подписать все документы, отправленные на почту", en: "Sign all documents sent by email" },
