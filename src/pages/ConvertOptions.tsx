...
import { ArrowLeft, ArrowRight, ArrowRightLeft, CheckCircle2, AlertTriangle, Info, ExternalLink, RefreshCw, ChevronRight } from "lucide-react";
...
export default function ConvertOptions() {
  ...
  const [screen, setScreen] = useState(0); // 0=explain, 1=steps, 2=calculator
  ...
  const steps = [
    ...
    "Выставляется счёт за регистрацию и KYC: 515 € (новый акционер) / 315 € (действующий). Стоимость может меняться.",
